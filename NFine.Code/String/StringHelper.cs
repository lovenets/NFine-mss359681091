...
namespace NFine.Code
{
    ...
    public class StringHelper
    {
        ...
        /// <summary>
        ///拼接一个新的字符串，如（0001,0002,0003-->'0001','0002','0003'）
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static string GetStrJionChar(string str)
        {
            string reuslt = "";
            if (!string.IsNullOrEmpty(str))
            {
                string[] newstr = GetStrArray(str);
        ...
        /// <returns></returns>
        public static string AddChar(string param1 = "")
        {
            if (!string.IsNullOrEmpty(param1))
            {
                ...
                if (param1.Contains(","))
                {
                    ...
                    if (str.Length > 0)
                    {
                        param1 = StringHelper.DelLastChar(str, ",");
                    }
                }
                else
                {
        ...
        /// <summary>
        /// 为逗号分隔符字符串添加单引号 ,并有字符前拼接字符  3U
        /// </summary>
        /// <param name="param1"></param>
        /// <returns></returns>
        public static string AddChar(string param1 = "", string join = "")
        {
            if (!string.IsNullOrEmpty(param1))
            {
                string str = string.Empty;
